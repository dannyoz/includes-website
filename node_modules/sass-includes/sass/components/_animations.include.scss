...
/// staggering effect using nth-child(n) selectors.  Please note that you will 
/// also need to define the keyframes that match the animation name. See @include
/// keyframes; or @include transformKeyframes;
/// @name animation
...
/// Sass maps are used to replicate the keframe syntax. 
