...
$googleFonts : (
	...
	lobster : (
		...
		weights : (
			400:(
				localone : 'Lobster',
				localtwo : 'Lobster-Regular',
				url : 'url(http://fonts.gstatic.com/s/lobster/v15/cycBf3mfbGkh66G5NhszPQ.woff2)'
	...
	arvo : (
		...
		weights : (
			400:(
				localone : 'Arvo',
				localtwo : 'Arvo',
				url : 'url(http://fonts.gstatic.com/s/arvo/v8/J0GYVYTizO1mjpT3aOcSbQ.woff2)'
			),
			700:(
				localone : 'Arvo Bold',
				localtwo : 'Arvo-Bold',
				url : 'url(http://fonts.gstatic.com/s/arvo/v8/Ya11CJGBCnKoJHvb8B2EOw.woff2)'
			)
		)
	)
);
